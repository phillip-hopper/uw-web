    ...
    usfmFiles.forEach(function(filename) {
      ...
      for (var i = 0, il = lines.length; i < il; i++) {
        ...
        switch (usfmData.key) {
          ...
          case 's2':
          case 'r':
            var formatted = usfmParser.formatText(usfmData.text, 0, 0);
          ...
          case 'v':
            if (currentVerse.isOpen) {
              /**
               * Close the previous verse
               */
              currentChapter.html += '</span>' + uwObject.htmlBreakingElement;
              currentVerse.isOpen = false;
            }
            ...
            var chapterAndVerse = currentChapter.number + ':' + currentVerse.number;
            var formattedVerse = usfmParser.formatText(usfmData.text, noteNumber, chapterAndVerse);
            /**
             * Add the formatted verse
             */
            currentChapter.html += bibleFormatter.openVerse(currentVerse.id, currentVerse.number) + formattedVerse.text;
            currentVerse.isOpen = true;
          break;
          default:
