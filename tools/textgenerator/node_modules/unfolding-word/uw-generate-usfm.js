...
var uwGenerateUsfm = function() {
      ...
      for (var i = 0, il = lines.length; i < il; i++) {
        ...
        switch (usfmData.key) {
          ...
          case 'id':
            ...
            currentBook = bibleDataParser.getBookInfoByUsfmCode(bookId);
          break;
          case 'c':
            /**
            ...
            currentChapter.title = currentBook.name + ' ' + currentChapter.number;
            currentChapter.id = bibleFormatter.formatChapterCode(currentBook.dbsCode, currentChapter.number);
          break;
        };
      };
      /**
   ...
   * 1) id      - (String) A combination of the book and chapter id (ex. JM1)
   * 3) number  - (Integer) The chapter number
   * 2) title   - (String) The title of the chapter
   * 
