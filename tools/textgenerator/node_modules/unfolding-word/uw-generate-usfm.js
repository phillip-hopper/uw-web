      ...
      for (var i = 0, il = lines.length; i < il; i++) {
        ...
        for (var ud = 0; ud < usfmLineData.length; ud++) {
          ...
          switch (usfmData.key) {
            ...
            case 'f':
              /**
               * Strip the indicator on the footnote
               */
              var formattedContent = usfmData.text;
              var firstSpace = formattedContent.indexOf(' ');
              var formattedContent = formattedContent.substring(firstSpace + 1);
              currentChapter.html += '<span class="note" id="note-' + noteNumber + '"><a class="key" href="#footnote-' + noteNumber + '">' + noteNumber + '</a><span class="text">' + formattedContent;
              noteNumber++;
